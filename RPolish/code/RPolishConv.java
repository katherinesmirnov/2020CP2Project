...
/**
   This program converts an expression to a reverse Polish expression
*/
public class RPolishConv
{
  public static void main(String[] args)
  {
    ...
    while (pos < expression.length())
    {
      ...
      if (isOperator(ch))
      {
        ...
        else
        {
          ...
          //else { evaluateTop(numstack, oldOp); }
            ...
            result = result +" "+ numstack.pop()+ " "+oldOp;
          }
          else{
            result = result+" "+numstack.pop()+" " +  numstack.pop()+" "+opstack.pop();
          }
          opstack.push(ch);
        ...
        while(!done){
          ...
          //else { evaluateTop(numstack, oldOp); }
            ...
            result = result + " "+numstack.pop()+" " +  numstack.pop()+" " +oldOp;
          }
        }
      }
      ...
      while (opstack.size() > 0)
      {
        ...
        else {result = result + " "+numstack.pop() +" "+oldOp;}
      }
      System.out.println(result);
      // if (numstack.size() == 0) { System.out.println(result); }
